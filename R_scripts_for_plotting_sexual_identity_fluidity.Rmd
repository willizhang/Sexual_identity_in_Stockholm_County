...
calculate_proportion_change <- function( df_list, identities ) {
  ...
  for ( df_name in names( df_list ) ) {
    ...
    for ( identity in identities ) {
      ...
      # calculate the number of individuals who identified as a specific identity in all three years
      n_no_change <- sum( df[ df$sexual_identity_2010 == identity & df$sexual_identity_2014 == identity &
      ...
      n_change <- n_identity - n_no_change
...
ggplot( data = results_long, 
  ...
  labs( x = NULL,
        y = "Proportion changed during 2010–2021ᵇ" ) +
  ...
  theme( axis.ticks.x = element_blank(),
         ...
         panel.grid.major = element_line( linetype = 'dashed', color = 'grey90' ),  # Major grid lines
         panel.grid.minor = element_line( linetype = 'dashed', color = 'grey90' ), # Minor grid lines
