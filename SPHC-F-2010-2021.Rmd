...
d_fluidity_model <- subset( d_2002_2006_2010_follow_up, 
                            select = -c( sexual_identity_2010, sexual_identity_2014, sexual_identity_2021 ) ) %>%
...
explanatory =  c( "year_exp", "sex_exp", "age_exp", "country_of_birth_exp", "education_exp", "income_exp", "marital_status_exp", "living_status_exp", "personal_support_exp" )
...
### 4. Relation between Changes in Sexual Identity and Demographic Factors
#### 4.1. Complete-case analysis
##### 4.1.1. Define model formula
```{r}
...
fml_year_model_2 <- sexual_identity_fluidity ~ year_exp + age_conf + sex_conf + country_of_birth_conf + education_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf
...
exposures <- c( "year", "age", "age_by_sex", "sex", "country_of_birth", "education", "income", "marital_status", "living_status", "personal_support" )
```

##### 4.1.2. Crude and adjusted analyses
```{r}
