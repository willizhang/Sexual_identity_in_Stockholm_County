...
The analyses examining the relationship between changes in sexual identity and key demographic factors in SPHC 2010 and 2014 are available, respectively, in the R Notebooks "SPHC-2010" and "SPHC-2014".
...
d_sexual_identity_fluidity <- d_2002_2006_2010_follow_up[ 
  !is.na( d_2002_2006_2010_follow_up$sexual_identity_2010 ) &
    ...
    !is.na( d_2002_2006_2010_follow_up$sexual_identity_2021 ), ]
...
d_2002_fluidity <- d_2002[ , c( "lopnr", "age_2010", "sex", "sexual_identity_2010", "sexual_identity_2014", "sexual_identity_2021", "sampling_strata_region" ) ]
d_2002_fluidity$year <- rep( "SPHC 2002", nrow( d_2002_fluidity ) )


d_2006_fluidity <- d_2006[ , c( "lopnr", "age_2010", "sex", "country_of_birth", "sexual_identity_2010", "sexual_identity_2014", "sexual_identity_2021", "sampling_strata_region" ) ]
d_2006_fluidity$year <- rep( "SPHC 2006", nrow( d_2006_fluidity ) )

length( intersect(d_2002_fluidity$lopnr, d_2006_fluidity$lopnr) )
