...
```{r}
summary( d_2010 )
selected_variables <- c( "sampling_strata_region", "no.of.population", "sample_size", "calibrated_weight", "sexual_identity_2010", "sexual_identity_2014", "sexual_identity_2021", "age", "sex", "country_of_birth", "utbniva2010", "occupation", "dispink2010", "marital_status", "living_alone", "F10U57G62" )

d_2010_incomplete <- d_2010 %>% 
  select( all_of( selected_variables ) ) %>%
  mutate( utbniva2010 = as.factor( utbniva2010 ),
          F10U57G62 = as.factor( F10U57G62 ) ) %>%
  rename( education = utbniva2010,
          income = dispink2010,
          personal_support = F10U57G62
          )
...
miss_var_summary( d_2010_incomplete ) # 58.0% missing in sexual_identity_2021, 41.2% in sexual_identity_2014,
# 3.8% in sexual_identity_2010, 1.3% in personal_support, 1.1% in living_alone, 0.7% in education
```
