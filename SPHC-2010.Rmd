...
##### 5.2.1. Calculate proportions of sexual identities
```{r}
...
# in Stockholm County
prop_imp_summary_overall_2010 <- calc_prop_imp_overall( design = survey_design_imp,
                                                        sexual_identities = sexual_identities,
                                                        year = 2010 )

# merge results
prop_imp_summary_2010 <- rbind( prop_imp_summary_subgroup_2010, prop_imp_summary_overall_2010 )
