...
selected_variables <- c( "sampling_strata_region", "no.of.population", "calibrated_weight", "sexual_identity_2010", "sexual_identity_2014", "sexual_identity_2021", "age", "sex", "country_of_birth", "education", "dispink2010", "marital_status", "living_alone", "personal_support" )
...
miss_var_summary( d_2010_incomplete ) # 58.0% missing in sexual_identity_2021, 41.2% in sexual_identity_2014, 3.8% in sexual_identity_2010, 1.3% in personal_support, 1.1% in living_alone, 0.7% in education
```
...
fml_imp_2010 <- sexual_identity_2021 + sexual_identity_2014 + sexual_identity_2010 + personal_support + living_alone + education ~ 1 + age*sex + country_of_birth + income + marital_status + ( 1 | weight_strata )
...
# income
summary( all_data_2010$income )
nrow( all_data_2010[ all_data_2010$income < 0 & !is.na( all_data_2010$income ), ] ) # 170 imputed values are negative
all_data_2010$income <-ifelse( all_data_2010$income < 0, 0, all_data_2010$income )
```
...
# exposures of interest, including sexual identity in 2010, age, sex, country of birth, education, income, marital status, living status, and personal support
levels( d_2010_cc_model_fluidity$sexual_identity_2010 )[ levels( d_2010_cc_model_fluidity$sexual_identity_2010 ) == "Uncertain"] <- "Other"
d_2010_cc_model_fluidity$sexual_identity_2010_exp <- relevel( d_2010_cc_model_fluidity$sexual_identity_2010, 
                                                              ref = "Heterosexual" )
...
# confounding variables, including sexual identity in 2010, age, sex, country of birth, education, income, marital status, 
# living status, personal support, and place of residence (i.e., sampling strata)
d_2010_cc_model_fluidity$sexual_identity_2010_conf <- d_2010_cc_model_fluidity$sexual_identity_2010
...
d_2010_cc_model_fluidity$living_status_conf <- d_2010_cc_model_fluidity$living_alone

d_2010_cc_model_fluidity$personal_support_conf <- as.factor( d_2010_cc_model_fluidity$F10U57G62 )
...
fml_sexual_identity_model_1 <- sexual_identity_fluidity ~ sexual_identity_2010_exp + age_conf + sex_conf + country_of_birth_conf
fml_sexual_identity_model_2 <- sexual_identity_fluidity ~ sexual_identity_2010_exp + age_conf + sex_conf + country_of_birth_conf + education_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf
...
fml_age_model_2 <- sexual_identity_fluidity ~ age_exp + sex_conf + country_of_birth_conf + education_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_age_by_sex_model_2 <- sexual_identity_fluidity ~ age_exp*sex_exp + country_of_birth_conf + education_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_sex_model_2 <- sexual_identity_fluidity ~ sex_exp + age_conf + country_of_birth_conf + education_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_country_of_birth_model_2 <- sexual_identity_fluidity ~ country_of_birth_exp + age_conf + sex_conf + education_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_education_model_2 <- sexual_identity_fluidity ~ education_exp + age_conf + sex_conf + country_of_birth_conf + income_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_income_model_2 <- sexual_identity_fluidity ~ income_exp + age_conf + sex_conf + country_of_birth_conf + education_conf + marital_status_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_marital_status_model_2 <- sexual_identity_fluidity ~ marital_status_exp + age_conf + sex_conf + country_of_birth_conf + education_conf + income_conf + living_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_living_status_model_2 <- sexual_identity_fluidity ~ living_status_exp + age_conf + sex_conf + country_of_birth_conf + education_conf + income_conf + marital_status_conf + personal_support_conf + place_of_residence_conf + sexual_identity_2010_conf
...
fml_personal_support_model_2 <- sexual_identity_fluidity ~ personal_support_exp + age_conf + sex_conf + country_of_birth_conf + education_conf + income_conf + marital_status_conf + living_status_conf + place_of_residence_conf + sexual_identity_2010_conf
