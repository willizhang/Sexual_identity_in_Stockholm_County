...
selected_variables <- c( "sampling_strata_region", "no.of.population", "calibrated_weight", "sexual_identity_2021", "age", "sex", "country_of_birth", "education", "dispink2021", "marital_status" )
...
# save( imp_preliminary_2021, file = "imp_preliminary_2021.RData" )
...
# save( imp_final_2021, file = "imp_final_2021.RData" )
...
nrow( all_data_2021[ all_data_2021$income < 0 & !is.na( all_data_2021$income ), ] ) # 168 imputed values are negative
all_data_2021$income <-ifelse( all_data_2021$income < 0, 0, all_data_2021$income )
```
