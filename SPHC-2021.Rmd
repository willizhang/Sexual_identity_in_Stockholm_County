...
fml_imp <- occupation + sexual_identity_2021 + education + income ~ 1 + age + sex + age*sex + country_of_birth + marital_status + ( 1 | weight_strata )
...
# increase the number of iterations and check trace and autocorrelation plots
# to determine the number of burn-in iterations for the final imputation
