...
x7 <- table( d_2021$occupation, d_2021$sexual_identity )
x7
...
d_2021_cc_model$sexual_minority <- ifelse( d_2021_cc_model$sexual_identity == "Heterosexual", 0, 1 )

d_2021_cc_model$homosexual <- ifelse( d_2021_cc_model$sexual_identity == "Homosexual", 1, 0 )

d_2021_cc_model$bisexual <- ifelse( d_2021_cc_model$sexual_identity == "Bisexual", 1, 0 )

d_2021_cc_model$other <- ifelse( d_2021_cc_model$sexual_identity == "None of the above", 1, 0 )
