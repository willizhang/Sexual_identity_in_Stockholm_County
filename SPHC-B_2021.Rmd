...
writexl::write_xlsx( sampling_frame_2021, "sampling_frame_2021.xlsx" ) # to be combined with SPHC-B 2010 and 2014 in order to make plots
...
d_2021_cc <- d_2021 %>%
  select(
      ...
      "no.of.population",
      "design_weight_unit_nonresponse",
      "calibrated_weight",
      "sexual_identity",
      "sex",
      "age_cat",
...
d_2021_cc$country_of_birth <- factor( 
  ifelse( d_2021_cc$country_of_birth == "Sweden", "Sweden",
          ifelse( d_2021_cc$country_of_birth == "Europe", "Europe", "Outside Europe" ) ),
  levels = c( "Sweden", "Europe", "Outside Europe" ) 
)

summary( d_2021_cc )

survey_design_cc <- svydesign(
  ids = ~ 1,
...
prop_cc_sex <- left_join( prop_cc_sex,
                          d_2021_cc[ !is.na( d_2021_cc$sexual_identity ) & !is.na( d_2021_cc$sex ),  ] %>% 
