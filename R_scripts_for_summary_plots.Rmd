...
long_data_2010$Identity <- factor( 
  
  ifelse(
    long_data_2010$Identity == "sexual_minority", "Sexual minorities",
    ifelse( long_data_2010$Identity == "homosexual", "Homosexual",
            ifelse( long_data_2010$Identity == "bisexual", "Bisexual", "Other" ) ) 
    ),
  
  levels = c( "Sexual minorities", "Homosexual", "Bisexual", "Other" )
  )

long_data_2010$Model <- factor(
  ifelse( long_data_2010$Model == "poisson", "Poisson",
          ifelse( long_data_2010$Model == "log_binomial", "Log-binomial", "Logistic" ) 
          ),
  levels = c( "Poisson", "Log-binomial", "Logistic" )
  )
