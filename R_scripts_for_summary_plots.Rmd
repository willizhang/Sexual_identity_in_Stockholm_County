...
##### 3.1.7. Proportion ratio by varing age cut-offs
```{r}
# import datasets
...
# modify table format
desired_order <- c( "age_exp16-29", "age_exp30-44", "age_exp>=60", "age_exp16-29_Male", "age_exp16-29_Female", "age_exp30-44_Male", "age_exp30-44_Female", "age_exp>=60_Male", "age_exp>=60_Female", "sex_expFemale", "country_of_birth_expEurope", "country_of_birth_expOutside Europe", "education_exp<=9 years", "education_exp10-12 years", "income_exp<=2,500", "income_exp(2,500, 3,500]", "income_exp(3,500, 4,500]", "marital_status_expNever married", "marital_status_expOther", "living_status_expyes", "personal_support_expno" )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Age group", .before = 1 )

results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Country of birth", .before = 12 )

results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Education years", .before = 15 )

results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Income (100 kr/yr)ᵉ", .before = 18 )

results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Marital statusᶠ", .before = 22 )
...
results_cc_pr_poisson$Exposure[ results_cc_pr_poisson$Exposure == "sex_expFemale" ] <- "Female\n\n"
...
results_cc_pr_poisson$Exposure[ results_cc_pr_poisson$Exposure == "living_status_expyes" ] <- "Living alone\n\n"
results_cc_pr_poisson$Exposure[ results_cc_pr_poisson$Exposure == "personal_support_expno" ] <- "No personal support\n\n"
...
```{r}
results_cc_pr_poisson_sexual_minority <- results_cc_pr_poisson[ -c( 5:10 ), c( 1:3, 34:36, 46:48, 58:60, 70:72, 82:84, 94:96 ) ]
...
names( results_cc_pr_poisson_sexual_minority )[ names( results_cc_pr_poisson_sexual_minority ) %in% c( "Exposure", "temp1", "temp2", "Sexual_minority_crude", "Sexual_minority" ) ] <- ""
...
p_cc_pr_poisson_sexual_minority <- edit_plot( p_cc_pr_poisson_sexual_minority,
                           row = c( 5, 9:11, 16:18, 20 ), 
                           which = "background",
                           gp = gpar( fill = "white" )
                           )

p_cc_pr_poisson_sexual_minority <- edit_plot( p_cc_pr_poisson_sexual_minority,
                           row = c( 1:4, 6:8, 12:15, 19 ), 
                           which = "background",
                           gp = gpar( fill = "#eff3f2" )
                           )
...
```{r}
results_cc_pr_poisson_homosexual <- results_cc_pr_poisson[ -c( 5:10 ), c( 1, 4, 5, 37:39, 49:51, 61:63, 73:75, 85:87, 97:99 ) ]
...
names( results_cc_pr_poisson_homosexual )[ names( results_cc_pr_poisson_homosexual ) %in% c( "Exposure", "temp1", "temp2", "Homosexual_crude", "Homosexual" ) ] <- ""
...
p_cc_pr_poisson_homosexual <- insert_text(
  p_cc_pr_poisson_homosexual,
  text = "Homosexual Sexual Identityᵃ",
  col = c( 3:7 ),
  row = 1,
  part = "header",
  gp = gpar(
...
```{r}
results_cc_pr_poisson_bisexual <- results_cc_pr_poisson[ -c( 5:10 ), c( 1, 6, 7, 40:42, 52:54, 64:66, 76:78, 88:90, 100:102 ) ]
...
names( results_cc_pr_poisson_bisexual )[ names( results_cc_pr_poisson_bisexual ) %in% c( "Exposure", "temp1", "temp2", "Bisexual_crude", "Bisexual" ) ] <- ""
...
p_cc_pr_poisson_bisexual <- insert_text(
  p_cc_pr_poisson_bisexual,
  text = "Bisexual Sexual Identityᵃ",
  col = c( 3:7 ),
  row = 1,
  part = "header",
  gp = gpar(
...
##### 4.1.5. Other group
```{r}
results_cc_pr_poisson_other <- results_cc_pr_poisson[ -c( 5:10 ), c( 1, 8, 9, 43:45, 55:57, 67:69, 79:81, 91:93, 103:105 ) ]
...
names( results_cc_pr_poisson_other )[ names( results_cc_pr_poisson_other ) %in% c( "Exposure", "temp1", "temp2", "Other_crude", "Other" ) ] <- ""
