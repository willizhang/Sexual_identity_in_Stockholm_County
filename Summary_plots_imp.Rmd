...
prop_imp_summary_2010 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_imp_summary_2010.xlsx")
prop_imp_summary_2014 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_imp_summary_2014.xlsx")
prop_imp_summary_2021 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_imp_summary_2021.xlsx")
...
```{r}
# datasets for proportion of sexual identity
prop_imp_summary_2010_generation <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_imp_summary_2010.xlsx")
prop_imp_summary_2014_generation <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_imp_summary_2014.xlsx")
prop_imp_summary_2021_generation <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_imp_summary_2021.xlsx")

prop_imp_summary_2010_generation <- prop_imp_summary_2010_generation %>% slice( 5:9 )
prop_imp_summary_2014_generation <- prop_imp_summary_2014_generation %>% slice( 5:10 )
prop_imp_summary_2021_generation <- prop_imp_summary_2021_generation %>% slice( 5:10 )
...
ggplot( drop_na( long_data_generation ), 
  ...
  facet_wrap( ~ identity, 
              ...
              labeller = labeller( identity = c( "Heterosexual" = "Heterosexual Identity",
                                                 "Homosexual" = "Homosexual Identity",
                                                 "Bisexual" = "Bisexual Identity",
                                                 "Other" = "Other Identitiesᵃ" ) ) ) +
  ggh4x::facetted_pos_scales( y = list(
    identity == "Heterosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0.7, 1 ), breaks = c( 0.7, 0.8, 0.9, 1 ) ),
    identity == "Homosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.032 ), breaks = c( 0, 0.01, 0.02, 0.03 ) ),
    identity == "Bisexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.1 ), breaks = c( 0, 0.05, 0.1 ) ),
    identity == "Other" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.32 ), breaks = c( 0, 0.1, 0.2, 0.3 ) ) 
    ) )
```
...
results_imp_pr_poisson_bisexual <- results_imp_pr_poisson[ -c( 9:14, 23:37 ), selected_cols ]
...
##### 3.4.2. Part 2
```{r}
results_imp_pr_poisson_bisexual <- results_imp_pr_poisson[ -c( 1:22 ), selected_cols ]
...
p_imp_pr_poisson_other <- insert_text(
  p_imp_pr_poisson_other,
  text = "Other/Other Sexual Identitiesᵃ",
  col = c( 3:10 ),
  row = 1,
  part = "header",
  gp = gpar(
...
results_imp_pr_poisson_age_sex$subgroup[ results_imp_pr_poisson_age_sex$subgroup == "age_exp16-29_Male" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
results_imp_pr_poisson_age_sex$subgroup[ results_imp_pr_poisson_age_sex$subgroup == "age_exp30-44_Male" ] <- paste0( "   ", "30–44 yrs\n\n" )
results_imp_pr_poisson_age_sex$subgroup[ results_imp_pr_poisson_age_sex$subgroup == "age_exp>=60_Male" ] <- paste0( "   ", "\u2265 60 yrs\n\n" )

results_imp_pr_poisson_age_sex$subgroup[ results_imp_pr_poisson_age_sex$subgroup == "age_exp16-29_Female" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
results_imp_pr_poisson_age_sex$subgroup[ results_imp_pr_poisson_age_sex$subgroup == "age_exp30-44_Female" ] <- paste0( "   ", "30–44 yrs\n\n" )
results_imp_pr_poisson_age_sex$subgroup[ results_imp_pr_poisson_age_sex$subgroup == "age_exp>=60_Female" ] <- paste0( "   ", "\u2265 60 yrs\n\n" )
...
colnames( results_imp_pr_poisson_age_sex_sexual_minorities )[1] <- "Demographic Factor"
...
colnames( results_imp_pr_poisson_age_sex_homosexual )[1] <- "Demographic Factor"
...
colnames( results_imp_pr_poisson_age_sex_bisexual )[1] <- "Demographic Factor"
...
colnames( results_imp_pr_poisson_age_sex_other )[1] <- "Demographic Factor"
...
```{r}
fluidity_imp_prop_summary_2010_2021 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/fluidity_cc_prop_summary_SPHC-F_2010-2021.xlsx")
...
fluidity_imp_prop_summary_2010_2021[ 4,1 ] <- "Other_identity"
fluidity_imp_prop_summary_2010_2021 <- fluidity_imp_prop_summary_2010_2021 %>%
  rename( changed_point_estimate = proportion,
          sample_size = count ) %>%
  select( -c( fluid_count ) )
colnames(fluidity_imp_prop_summary_2010_2021)[-1] <- paste0(colnames(fluidity_imp_prop_summary_2010_2021)[-1], "_2010_2021")

# to make it easier to combine across datasets
# a note on these changes will be added on the graph later
fluidity_imp_prop_summary_2010_2021$subgroup[ fluidity_imp_prop_summary_2010_2021$subgroup == "<=29" ] <- "16-29"
fluidity_imp_prop_summary_2010_2021$subgroup[ fluidity_imp_prop_summary_2010_2021$subgroup == "<=29.Male" ] <- "16-29.Male"
fluidity_imp_prop_summary_2010_2021$subgroup[ fluidity_imp_prop_summary_2010_2021$subgroup == "<=29.Female" ] <- "16-29.Female"
...
# merge datasets
fluidity_imp_prop_summary <- fluidity_imp_prop_summary_2010_2021 %>%
  full_join( fluidity_imp_prop_summary_2010, by = "subgroup" ) %>%
...
fluidity_imp_prop_summary <- fluidity_imp_prop_summary %>% 
  add_row( subgroup = "Cohort yearᵍ", .before = 47 )
...
fluidity_imp_prop_summary$subgroup <- ifelse( ( is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
                                                 is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ) ) | 
...
fluidity_imp_prop_summary$subgroup[ fluidity_imp_prop_summary$subgroup == "Stockholm County" ] <- "Stockholm Countyʰ"
...
fluidity_imp_prop_summary <- fluidity_imp_prop_summary %>% 
  add_column( "SPHC-F 2010-2021" = paste0(
    sprintf( "%.1f", fluidity_imp_prop_summary$changed_point_estimate_2010_2021*100 ), " (", 
    sprintf( "%.1f", fluidity_imp_prop_summary$changed_lower_ci_2010_2021*100 ), ", ", 
    sprintf( "%.1f", fluidity_imp_prop_summary$changed_upper_ci_2010_2021*100 ), ")" ),
    .before = 3 )
...
fluidity_imp_prop_summary$`SPHC-F 2010-2021` <- ifelse( 
  is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_imp_prop_summary$`SPHC-F 2010-2021` )
fluidity_imp_prop_summary$`SPHC-F 2010-2021`[ fluidity_imp_prop_summary$`SPHC-F 2010-2021` == "NA (NA, NA)" ] <- "\u2013"

fluidity_imp_prop_summary$`SPHC 2010` <- ifelse( 
  is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_imp_prop_summary$`SPHC 2010` )
fluidity_imp_prop_summary$`SPHC 2010`[ fluidity_imp_prop_summary$`SPHC 2010` == "NA (NA, NA)" ] <- "\u2013"

fluidity_imp_prop_summary$`SPHC 2014` <- ifelse( 
  is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_imp_prop_summary$`SPHC 2014` )
fluidity_imp_prop_summary$`SPHC 2014`[ fluidity_imp_prop_summary$`SPHC 2014` == "NA (NA, NA)" ] <- "\u2013"

fluidity_imp_prop_summary$sample_size_2010_2021 <- prettyNum( fluidity_imp_prop_summary$sample_size_2010_2021, big.mark = ",", preserve.width = "none" )

fluidity_imp_prop_summary$sample_size_2010_2021 <- ifelse(
  is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_imp_prop_summary$sample_size_2010_2021
)
fluidity_imp_prop_summary$sample_size_2010_2021[ fluidity_imp_prop_summary$sample_size_2010_2021 == "NA" ] <- "\u2013"

fluidity_imp_prop_summary$sample_size_2010 <- ifelse(
  is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_imp_prop_summary$sample_size_2010
)
fluidity_imp_prop_summary$sample_size_2010[ is.na( fluidity_imp_prop_summary$sample_size_2010 ) ] <- "\u2013"

fluidity_imp_prop_summary$sample_size_2014 <- ifelse(
  is.na( fluidity_imp_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_imp_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_imp_prop_summary$sample_size_2014
)
fluidity_imp_prop_summary$sample_size_2014[ is.na( fluidity_imp_prop_summary$sample_size_2014 ) ] <- "\u2013"
...
names( fluidity_imp_prop_summary_updated )[ names( fluidity_imp_prop_summary_updated ) %in% c( "temp1", "temp2", "temp3", "temp4", "temp5", "temp6" ) ] <- ""

colnames( fluidity_imp_prop_summary_updated )[ colnames( fluidity_imp_prop_summary_updated ) == "SPHC-F 2010-2021" ] <- ""
colnames( fluidity_imp_prop_summary_updated )[ colnames( fluidity_imp_prop_summary_updated ) == "SPHC 2010" ] <- ""
colnames( fluidity_imp_prop_summary_updated )[ colnames( fluidity_imp_prop_summary_updated ) == "SPHC 2014" ] <- ""

colnames( fluidity_imp_prop_summary_updated )[ colnames( fluidity_imp_prop_summary_updated ) == "sample_size_2010_2021" ] <- ""
colnames( fluidity_imp_prop_summary_updated )[ colnames( fluidity_imp_prop_summary_updated ) == "sample_size_2010" ] <- ""
colnames( fluidity_imp_prop_summary_updated )[ colnames( fluidity_imp_prop_summary_updated ) == "sample_size_2014" ] <- ""
```
...
fluidity_imp_prop_summary_updated_part_1 <- fluidity_imp_prop_summary_updated[ c( 1:13, 24:40, 51 ), ]

p_prop_imp_fluidity <- forest(
  fluidity_imp_prop_summary_updated_part_1[ , c( 1:16 ) ],
  
  est = list( fluidity_imp_prop_summary_updated_part_1$changed_point_estimate_2010_2021*100,
              fluidity_imp_prop_summary_updated_part_1$changed_point_estimate_2010*100,
              fluidity_imp_prop_summary_updated_part_1$changed_point_estimate_2014*100
  ),
  
  lower = list( fluidity_imp_prop_summary_updated_part_1$changed_lower_ci_2010_2021*100,
                fluidity_imp_prop_summary_updated_part_1$changed_lower_ci_2010*100,
                fluidity_imp_prop_summary_updated_part_1$changed_lower_ci_2014*100
  ),
  
  upper = list( fluidity_imp_prop_summary_updated_part_1$changed_upper_ci_2010_2021*100,
                fluidity_imp_prop_summary_updated_part_1$changed_upper_ci_2010*100,
  ...
  ref_line = c( fluidity_imp_prop_summary_2010_2021[ fluidity_imp_prop_summary_2010_2021$subgroup == "Stockholm County", ]$changed_point_estimate_2010_2021*100,
              fluidity_imp_prop_summary_2010[ fluidity_imp_prop_summary_2010$subgroup == "Stockholm County", ]$changed_point_estimate_2010*100,
              fluidity_imp_prop_summary_2014[ fluidity_imp_prop_summary_2014$subgroup == "Stockholm County", ]$changed_point_estimate_2014*100 ),
...
fluidity_imp_prop_summary_updated_part_2 <- fluidity_imp_prop_summary_updated[ c( 41:50 ), ]

p_prop_imp_fluidity <- forest(
  fluidity_imp_prop_summary_updated_part_2[ , c( 1:16 ) ],
  
  est = list( fluidity_imp_prop_summary_updated_part_2$changed_point_estimate_2010_2021*100,
              fluidity_imp_prop_summary_updated_part_2$changed_point_estimate_2010*100,
              fluidity_imp_prop_summary_updated_part_2$changed_point_estimate_2014*100
  ),
  
  lower = list( fluidity_imp_prop_summary_updated_part_2$changed_lower_ci_2010_2021*100,
                fluidity_imp_prop_summary_updated_part_2$changed_lower_ci_2010*100,
                fluidity_imp_prop_summary_updated_part_2$changed_lower_ci_2014*100
  ),
  
  upper = list( fluidity_imp_prop_summary_updated_part_2$changed_upper_ci_2010_2021*100,
                fluidity_imp_prop_summary_updated_part_2$changed_upper_ci_2010*100,
...
fluidity_imp_prop_summary_updated_part_3 <- fluidity_imp_prop_summary_updated[ c( 14:23, 55 ), ]
fluidity_imp_prop_summary_updated_part_3$Subgroup[ fluidity_imp_prop_summary_updated_part_3$Subgroup == "Stockholm Countyᵍ" ] <- "Stockholm Countyᶜ"

p_prop_imp_fluidity <- forest(
  fluidity_imp_prop_summary_updated_part_3[ , c( 1:16 ) ],
  
  est = list( fluidity_imp_prop_summary_updated_part_3$changed_point_estimate_2010_2021*100,
              fluidity_imp_prop_summary_updated_part_3$changed_point_estimate_2010*100,
              fluidity_imp_prop_summary_updated_part_3$changed_point_estimate_2014*100
  ),
  
  lower = list( fluidity_imp_prop_summary_updated_part_3$changed_lower_ci_2010_2021*100,
                fluidity_imp_prop_summary_updated_part_3$changed_lower_ci_2010*100,
                fluidity_imp_prop_summary_updated_part_3$changed_lower_ci_2014*100
  ),
  
  upper = list( fluidity_imp_prop_summary_updated_part_3$changed_upper_ci_2010_2021*100,
                fluidity_imp_prop_summary_updated_part_3$changed_upper_ci_2010*100,
                fluidity_imp_prop_summary_updated_part_3$changed_upper_ci_2014*100
  ),
  
  ci_column = c( 3, 8, 13 ),
  is_summary = c( rep( FALSE, nrow( fluidity_imp_prop_summary_updated_part_3 ) - 1 ), TRUE ),
  sizes = 0.4,
...
fluidity_imp_rr_SPHC_F_2010_2021 <- read_xlsx("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/fluidity_cc_rr_SPHC-F_2010-2021.xlsx")

colnames(fluidity_imp_rr_SPHC_F_2010_2021)[1] <- "subgroup"
colnames(fluidity_imp_rr_SPHC_F_2010_2021)[-1] <- paste0(colnames(fluidity_imp_rr_SPHC_F_2010_2021)[-1], "_2010_2021")
...
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "age_exp<=29" ] <- "age_exp16-29"
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "age_exp<=29_Male" ] <- "age_exp16-29_Male"
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "age_exp<=29_Female" ] <- "age_exp16-29_Female"
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "living_status_expyes" ] <- "living_status_expliving_alone_yes"
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "personal_support_expno" ] <- "personal_support_exppersonal_support_no"
...
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "sexual_identity_2010_expHomosexual" ] <- "Homosexual"
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "sexual_identity_2010_expBisexual" ] <- "Bisexual"
fluidity_imp_rr_SPHC_F_2010_2021$subgroup[ fluidity_imp_rr_SPHC_F_2010_2021$subgroup == "sexual_identity_2010_expOther" ] <- "Other"

# merge datasets
fluidity_imp_rr <- fluidity_imp_rr_SPHC_F_2010_2021 %>%
  full_join( fluidity_imp_rr_2010, by = "subgroup" ) %>%
  full_join( fluidity_imp_rr_2014, by = "subgroup" )

# modify table format
desired_order <- c( "Homosexual", "Bisexual", "Other", "sex_expFemale", "age_exp16-29", "age_exp30-44", "age_exp>=60", "age_exp16-29_Male", "age_exp30-44_Male", "age_exp>=60_Male", "age_exp16-29_Female", "age_exp30-44_Female", "age_exp>=60_Female", "country_of_birth_expEurope", "country_of_birth_expOutside Europe", "education_exp<=9 years", "education_exp10-12 years", "income_exp<=2,500", "income_exp(2,500, 3,500]", "income_exp(3,500, 4,500]", "marital_status_expNever married", "marital_status_expOther", "living_status_expliving_alone_yes", "personal_support_exppersonal_support_no", "year_expSPHC 2006", "year_expSPHC 2010" )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = "Sexual identityⁱ", .before = 1 )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = "Income (100 kr/yr)ᶠ", .before = 25 )

fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = "Marital statusᵍ", .before = 29 )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = "Cohort yearʰ", .before = 36 )
...
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "year_expSPHC 2006" ] <- paste0( "   ", "SPHC 2006\n\n" )
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "year_expSPHC 2010" ] <- paste0( "   ", "SPHC 2010\n\n" )
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "sex_expFemale" ] <- paste0( "   ", "Female\n\n" )
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "age_exp16-29" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
...
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "age_exp16-29_Male" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
...
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "age_exp16-29_Female" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
...
fluidity_imp_rr$subgroup[ fluidity_imp_rr$subgroup == "country_of_birth_expEurope" ] <- paste0( "   ", "Europeᵉ\n\n" )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_column( "Sexual_fluidity_crude_2010_2021" = paste0(
    sprintf( "%.2f", fluidity_imp_rr$point_estimate_crude_2010_2021 ), " (", 
    sprintf( "%.2f", fluidity_imp_rr$lower_ci_crude_2010_2021 ), ", ", 
    sprintf( "%.2f", fluidity_imp_rr$upper_ci_crude_2010_2021 ), ")" ),
    .before = 2 )

fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_column( "Sexual_fluidity_model_1_2010_2021" = paste0(
    sprintf( "%.2f", fluidity_imp_rr$point_estimate_model_1_2010_2021 ), " (", 
    sprintf( "%.2f", fluidity_imp_rr$lower_ci_model_1_2010_2021 ), ", ", 
    sprintf( "%.2f", fluidity_imp_rr$upper_ci_model_1_2010_2021 ), ")" ),
    .before = 3 )

fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_column( "Sexual_fluidity_model_2_2010_2021" = paste0(
    sprintf( "%.2f", fluidity_imp_rr$point_estimate_model_2_2010_2021 ), " (", 
    sprintf( "%.2f", fluidity_imp_rr$lower_ci_model_2_2010_2021 ), ", ", 
    sprintf( "%.2f", fluidity_imp_rr$upper_ci_model_2_2010_2021 ), ")" ),
    .before = 4 )
...
fluidity_imp_rr$Sexual_fluidity_2010_crude <- ifelse( !is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ) & is.na( fluidity_imp_rr$point_estimate_2010_crude ), "\u2013",
                                                            fluidity_imp_rr$Sexual_fluidity_2010_crude )

fluidity_imp_rr$Sexual_fluidity_2010_model_1 <- ifelse( !is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ) & is.na( fluidity_imp_rr$point_estimate_2010_crude ), "\u2013",
                                                            fluidity_imp_rr$Sexual_fluidity_2010_model_1 )

fluidity_imp_rr$Sexual_fluidity_2010_model_2 <- ifelse( !is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ) & is.na( fluidity_imp_rr$point_estimate_2010_crude ), "\u2013",
                                                            fluidity_imp_rr$Sexual_fluidity_2010_model_2 )

fluidity_imp_rr$Sexual_fluidity_2014_crude <- ifelse( !is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ) & is.na( fluidity_imp_rr$point_estimate_2010_crude ), "\u2013",
                                                            fluidity_imp_rr$Sexual_fluidity_2014_crude )

fluidity_imp_rr$Sexual_fluidity_2014_model_1 <- ifelse( !is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ) & is.na( fluidity_imp_rr$point_estimate_2010_crude ), "\u2013",
                                                            fluidity_imp_rr$Sexual_fluidity_2014_model_1 )

fluidity_imp_rr$Sexual_fluidity_2014_model_2 <- ifelse( !is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ) & is.na( fluidity_imp_rr$point_estimate_2010_crude ), "\u2013",
                                                            fluidity_imp_rr$Sexual_fluidity_2014_model_2 )

fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_column( "Sexual_fluidity_crude" = paste( fluidity_imp_rr$Sexual_fluidity_crude_2010_2021,
                                               fluidity_imp_rr$Sexual_fluidity_2010_crude,
                                               fluidity_imp_rr$Sexual_fluidity_2014_crude,
                                               sep = "\n" ),
              .before = 2 )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_column( "Sexual_fluidity_model_1" = paste( fluidity_imp_rr$Sexual_fluidity_model_1_2010_2021,
                                                 fluidity_imp_rr$Sexual_fluidity_2010_model_1,
                                                 fluidity_imp_rr$Sexual_fluidity_2014_model_1,
                                                 sep = "\n" ),
              .before = 3 )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_column( "Sexual_fluidity_model_2" = paste( fluidity_imp_rr$Sexual_fluidity_model_2_2010_2021,
                                                 fluidity_imp_rr$Sexual_fluidity_2010_model_2,
                                                 fluidity_imp_rr$Sexual_fluidity_2014_model_2,
                                                 sep = "\n" ),
              .before = 4 )
...
fluidity_imp_rr$Sexual_fluidity_crude <- ifelse( is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ), "",
                                                       fluidity_imp_rr$Sexual_fluidity_crude )

fluidity_imp_rr$Sexual_fluidity_model_1 <- ifelse( is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ), "",
                                                       fluidity_imp_rr$Sexual_fluidity_model_1 )

fluidity_imp_rr$Sexual_fluidity_model_2 <- ifelse( is.na( fluidity_imp_rr$point_estimate_crude_2010_2021 ), "",
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = paste0( "   ", "SPHC 2002" ), 
           Sexual_fluidity_crude = "Reference",
           Sexual_fluidity_model_1 = "Reference",
           Sexual_fluidity_model_2 = "Reference",
           .before = 48 )
...
fluidity_imp_rr_part_1 <- fluidity_imp_rr[ -c( 1:5, 14:23, 32:50 ), ]

p_imp_pr_poisson_sexual_fluidity <- forest(
  fluidity_imp_rr_part_1[ , c( 1:10 ) ],
  
  est = list( fluidity_imp_rr_part_1$point_estimate_crude_2010_2021,
              fluidity_imp_rr_part_1$point_estimate_model_1_2010_2021,
              fluidity_imp_rr_part_1$point_estimate_model_2_2010_2021,
              
              fluidity_imp_rr_part_1$point_estimate_2010_crude,
  ...
  lower = list( fluidity_imp_rr_part_1$lower_ci_crude_2010_2021,
                fluidity_imp_rr_part_1$lower_ci_model_1_2010_2021,
                fluidity_imp_rr_part_1$lower_ci_model_2_2010_2021,
                
                fluidity_imp_rr_part_1$lower_ci_2010_crude,
  ...
  upper = list( fluidity_imp_rr_part_1$upper_ci_crude_2010_2021,
                fluidity_imp_rr_part_1$upper_ci_model_1_2010_2021,
                fluidity_imp_rr_part_1$upper_ci_model_2_2010_2021,
                
                fluidity_imp_rr_part_1$upper_ci_2010_crude,
...
p_imp_pr_poisson_sexual_fluidity <- insert_text(
  p_imp_pr_poisson_sexual_fluidity,
  text = "Change in Sexual Identityᵃ",
  col = c( 3:10 ),
  row = 1,
  part = "header",
  gp = gpar(
...
fluidity_imp_rr_part_2 <- fluidity_imp_rr[ -c( 1:31 ), ]

p_imp_pr_poisson_sexual_fluidity <- forest(
  fluidity_imp_rr_part_2[ , c( 1:10 ) ],
  
  est = list( fluidity_imp_rr_part_2$point_estimate_crude_2010_2021,
              fluidity_imp_rr_part_2$point_estimate_model_1_2010_2021,
              fluidity_imp_rr_part_2$point_estimate_model_2_2010_2021,
              
              fluidity_imp_rr_part_2$point_estimate_2010_crude,
  ...
  lower = list( fluidity_imp_rr_part_2$lower_ci_crude_2010_2021,
                fluidity_imp_rr_part_2$lower_ci_model_1_2010_2021,
                fluidity_imp_rr_part_2$lower_ci_model_2_2010_2021,
                
                fluidity_imp_rr_part_2$lower_ci_2010_crude,
  ...
  upper = list( fluidity_imp_rr_part_2$upper_ci_crude_2010_2021,
                fluidity_imp_rr_part_2$upper_ci_model_1_2010_2021,
                fluidity_imp_rr_part_2$upper_ci_model_2_2010_2021,
                
                fluidity_imp_rr_part_2$upper_ci_2010_crude,
...
fluidity_imp_rr_part_3 <- fluidity_imp_rr[ c( 1:5 ), ]

p_imp_pr_poisson_sexual_fluidity <- forest(
  fluidity_imp_rr_part_3[ , c( 1:10 ) ],
  
  est = list( fluidity_imp_rr_part_3$point_estimate_crude_2010_2021,
              fluidity_imp_rr_part_3$point_estimate_model_1_2010_2021,
              fluidity_imp_rr_part_3$point_estimate_model_2_2010_2021,
              
              fluidity_imp_rr_part_3$point_estimate_2010_crude,
              fluidity_imp_rr_part_3$point_estimate_2010_model_1,
              fluidity_imp_rr_part_3$point_estimate_2010_model_2,
              
              fluidity_imp_rr_part_3$point_estimate_2014_crude,
              fluidity_imp_rr_part_3$point_estimate_2014_model_1,
              fluidity_imp_rr_part_3$point_estimate_2014_model_2
  ),
  
  lower = list( fluidity_imp_rr_part_3$lower_ci_crude_2010_2021,
                fluidity_imp_rr_part_3$lower_ci_model_1_2010_2021,
                fluidity_imp_rr_part_3$lower_ci_model_2_2010_2021,
                
                fluidity_imp_rr_part_3$lower_ci_2010_crude,
                fluidity_imp_rr_part_3$lower_ci_2010_model_1,
                fluidity_imp_rr_part_3$lower_ci_2010_model_2,
                
                fluidity_imp_rr_part_3$lower_ci_2014_crude,
                fluidity_imp_rr_part_3$lower_ci_2014_model_1,
                fluidity_imp_rr_part_3$lower_ci_2014_model_2
  ),
  
  upper = list( fluidity_imp_rr_part_3$upper_ci_crude_2010_2021,
                fluidity_imp_rr_part_3$upper_ci_model_1_2010_2021,
                fluidity_imp_rr_part_3$upper_ci_model_2_2010_2021,
                
                fluidity_imp_rr_part_3$upper_ci_2010_crude,
                fluidity_imp_rr_part_3$upper_ci_2010_model_1,
                fluidity_imp_rr_part_3$upper_ci_2010_model_2,
                
                fluidity_imp_rr_part_3$upper_ci_2014_crude,
                fluidity_imp_rr_part_3$upper_ci_2014_model_1,
                fluidity_imp_rr_part_3$upper_ci_2014_model_2
  ),
...
p_imp_pr_poisson_sexual_fluidity <- forest(
  ...
  est = list( fluidity_imp_rr_age_by_sex$point_estimate_crude_2010_2021,
              fluidity_imp_rr_age_by_sex$point_estimate_model_1_2010_2021,
              fluidity_imp_rr_age_by_sex$point_estimate_model_2_2010_2021,
              
              fluidity_imp_rr_age_by_sex$point_estimate_2010_crude,
  ...
  lower = list( fluidity_imp_rr_age_by_sex$lower_ci_crude_2010_2021,
                fluidity_imp_rr_age_by_sex$lower_ci_model_1_2010_2021,
                fluidity_imp_rr_age_by_sex$lower_ci_model_2_2010_2021,
                
                fluidity_imp_rr_age_by_sex$lower_ci_2010_crude,
  ...
  upper = list( fluidity_imp_rr_age_by_sex$upper_ci_crude_2010_2021,
                fluidity_imp_rr_age_by_sex$upper_ci_model_1_2010_2021,
                fluidity_imp_rr_age_by_sex$upper_ci_model_2_2010_2021,
                
                fluidity_imp_rr_age_by_sex$upper_ci_2010_crude,
