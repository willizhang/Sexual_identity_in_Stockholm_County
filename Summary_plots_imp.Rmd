...
ggplot( drop_na( long_data_generation ), 
  ...
  ggh4x::facetted_pos_scales( y = list(
    identity == "Heterosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0.69, 1 ), breaks = c( 0.7, 0.8, 0.9, 1 ) ),
    identity == "Homosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.031 ), breaks = c( 0, 0.01, 0.02, 0.03 ) ),
    identity == "Bisexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.1 ), breaks = c( 0, 0.05, 0.1 ) ),
    identity == "Other" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.31 ), breaks = c( 0, 0.1, 0.2, 0.3 ) ) 
    ) )
```
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = "Sexual identityᵈ", .before = 1 )
...
fluidity_imp_rr <- fluidity_imp_rr %>% 
  add_row( subgroup = "Marital statusᵉ", .before = 29 )
