...
```{r}
# NOTES: 'SPHC-C + year' refers to the baseline survey in the Stockholm Public Health Cohort (SPHC); for example, SPHC-C 2010 represents the baseline survey in 2010. 'SPHC-F + year' refers to the follow-up survey; for example, SPHC-F 2014 represents the follow-up survey in 2014.

### SPHC-C 2002 with SPHC-F 2010-2021 ###
...
### SPHC-C 2006 with SPHC-F 2010-2021 ###
...
### SPHC-C 2010 with SPHC-F 2014-2021 ###
...
### 2010-2021 ###
# based on respondents who reported sexual identity in SPHC-F 2010, 2014 and 2021 from SPHC-C 2002, 2006 
# and 2010, including those in SPHC-C 2010
...
m1$year <- rep( "SPHC-C 2002", nrow(m1) )
...
m2$year <- rep( "SPHC-C 2006", nrow(m2) )
...
m3$year <- rep( "SPHC-C 2010", nrow(m3) )
...
m123$age_2010_cat <- factor( ifelse( m123$age_2010 <= 29, "18-29", 
...
m123_age$percent <- ifelse( m123_age$age_group == "18-29", m123_age$number/sum( m123_age[ m123_age$age_group == "18-29", ]$number ),
...
m123_age_18 <- m123_age[ m123_age$age_group == "18-29", ]
