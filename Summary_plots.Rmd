...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Male", .before = 7 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Female", .before = 11 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Country of birth", .before = 15 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Education years", .before = 18 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Income (100 kr/yr)ᶠ", .before = 21 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Marital statusᵍ", .before = 25 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Living alone", .before = 28 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Personal support", .before = 30 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Cohort yearʰ", .before = 32 )
...
fluidity_cc_rr_part_1 <- fluidity_cc_rr[ -c( 9:18, 27:45 ), ]
...
fluidity_cc_rr_part_2 <- fluidity_cc_rr[ -c( 1:26 ), ]
...
fluidity_cc_rr_age_by_sex <- fluidity_cc_rr[ c( 9:18 ), ]
