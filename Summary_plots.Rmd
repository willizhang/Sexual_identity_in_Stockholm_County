...
sampling_frame_2002_males <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/sampling_frame_2002_males.xlsx")
sampling_frame_2002_females <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/sampling_frame_2002_females.xlsx")
sampling_frame_2006 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/sampling_frame_2006.xlsx")
sampling_frame_2010 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/sampling_frame_2010.xlsx")
sampling_frame_2014 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/sampling_frame_2014.xlsx")
sampling_frame_2021 <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/sampling_frame_2021.xlsx")

combined_response_rate <- sampling_frame_2002_males[, c( 1, 6:8 ) ] %>%
  full_join( sampling_frame_2002_females[, c( 1, 6:8 ) ], by = "sampling_strata_region" ) %>%
  full_join( sampling_frame_2006[, c( 1, 7:9 ) ], by = "sampling_strata_region" ) %>%
  full_join( sampling_frame_2010[, c( 1, 6:8 ) ], by = "sampling_strata_region" ) %>%
...
colnames( combined_response_rate ) <- c( "Municipality",
                                         "unitresponse_rate_2002_male",
                                         "itemresponse_rate_2002_male",
                                         "overallresponse_rate_2002_male",
                                         "unitresponse_rate_2002_female",
                                         "itemresponse_rate_2002_female",
                                         "overallresponse_rate_2002_female",
                                         "unitresponse_rate_2006",
                                         "itemresponse_rate_2006",
                                         "overallresponse_rate_2006",
...
combined_response_rate$Municipality[ combined_response_rate$Municipality == "Additional_stratum_male" ] <- "Unknown"
combined_response_rate$Municipality[ combined_response_rate$Municipality == "Additional_stratum_female" ] <- "Unknown"

combined_response_rate_merged <- combined_response_rate %>%
  group_by( Municipality ) %>%
  summarize( across( everything(), ~ ifelse( all (is.na(.) ), NA, na.omit(.) ) ) )

combined_response_rate_merged <- combined_response_rate_merged %>%
  mutate( missing_count = rowSums(is.na(select(., -Municipality)))) %>%
  arrange(missing_count, Municipality)

combined_response_rate_merged$Municipality <- factor(combined_response_rate_merged$Municipality, levels = unique(combined_response_rate_merged$Municipality))

ordered_levels <- combined_response_rate$Municipality[ order( combined_response_rate$overallresponse_rate_2010, 
                                                              decreasing = TRUE ) ]
ordered_levels <- as.character( ordered_levels[ ordered_levels != "Älvsjö" & 
                                                  ordered_levels != "Hägersten-Liljeholmen" &
                                                  ordered_levels != "Hägersten-Älvsjö" ] )
ordered_levels <- c( "Hägersten-Älvsjö", ordered_levels, "Älvsjö", "Hägersten-Liljeholmen" )

combined_response_rate$Municipality <- factor( combined_response_rate$Municipality, 
                                               levels = ordered_levels )

df_long <- combined_response_rate_merged %>%
  pivot_longer(
    cols = -Municipality,
    names_to = c( ".value", "year" ),
    names_pattern = "(.*response_rate)_(\\d+.*$)"
    ) %>%
  gather( key = "response_type", value = "response_rate", unitresponse_rate, itemresponse_rate, overallresponse_rate )

df_long$response_type <- factor( df_long$response_type, 
                                 levels = c( "unitresponse_rate", "itemresponse_rate", "overallresponse_rate" ) )


# plot
year_labels <- c( `2002_male` = "SPHC-B 2002, Males",
                  `2002_female` = "SPHC-B 2002, Females",
                  `2006` = "SPHC-B 2006",
                  `2010` = "SPHC-B 2010", 
                  `2014` = "SPHC-B 2014", 
                  `2021` = "SPHC-B 2021" )
...
ggplot( df_long, 
        aes( x = Municipality, y = response_rate, group = interaction( year, response_type ) ) ) +
  
  geom_line( aes( color = year, linetype = response_type ) ) +
  
  scale_linetype_manual( values = c( "unitresponse_rate" = "dashed", 
                                     "itemresponse_rate" = "dotdash", 
                                     "overallresponse_rate" = "solid" ),
                         labels = c( "Unit response rate", "Item response rate", "Overall response rate" ),
                         name = "Response type" ) +
...
### 3. Plots for Proportion of Sexual Identity
...
### 4. Plots for Relation between Sexual Identity and Demographic Factors
#### 4.1. Complete-case analysis
##### 4.1.1. Prepare dataset for plotting
```{r}
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Income (100 kr/yr)ᵉ", .before = 19 )

results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = "Marital statusᶠ", .before = 23 )
...
results_cc_pr_poisson$Exposure[ results_cc_pr_poisson$Exposure == "age_exp16-29" ] <- paste0( "   ", "16–29 yrsᶜ\n\n" )
...
results_cc_pr_poisson$Exposure[ results_cc_pr_poisson$Exposure == "country_of_birth_expEurope" ] <- paste0( "   ", "Europeᵈ\n\n" )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Sexual_minority_2010" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_point_estimate_2010 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_lower_ci_2010 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_upper_ci_2010 ), ")" ),
    .before = 3 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Homosexual_2010" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_point_estimate_2010 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_lower_ci_2010 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_upper_ci_2010 ), ")" ),
    .before = 5 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Bisexual_2010" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_point_estimate_2010 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_lower_ci_2010 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_upper_ci_2010 ), ")" ),
    .before = 7 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Other_2010" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$other_point_estimate_2010 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$other_lower_ci_2010 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$other_upper_ci_2010 ), ")" ),
    .before = 9 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Sexual_minority_2014" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_point_estimate_2014 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_lower_ci_2014 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_upper_ci_2014 ), ")" ),
    .before = 11 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Homosexual_2014" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_point_estimate_2014 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_lower_ci_2014 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_upper_ci_2014 ), ")" ),
    .before = 13 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Bisexual_2014" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_point_estimate_2014 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_lower_ci_2014 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_upper_ci_2014 ), ")" ),
    .before = 15 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Other_2014" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$other_point_estimate_2014 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$other_lower_ci_2014 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$other_upper_ci_2014 ), ")" ),
    .before = 17 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Sexual_minority_2021" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_lower_ci_2021 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$sexual_minority_upper_ci_2021 ), ")" ),
    .before = 19 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Homosexual_2021" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_point_estimate_2021 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_lower_ci_2021 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$homosexual_upper_ci_2021 ), ")" ),
    .before = 21 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Bisexual_2021" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_point_estimate_2021 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_lower_ci_2021 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$bisexual_upper_ci_2021 ), ")" ),
    .before = 23 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Other_2021" = paste0(
    sprintf( "%.2f", results_cc_pr_poisson$other_point_estimate_2021 ), " (", 
    sprintf( "%.2f", results_cc_pr_poisson$other_lower_ci_2021 ), ", ", 
    sprintf( "%.2f", results_cc_pr_poisson$other_upper_ci_2021 ), ")" ),
    .before = 25 )

results_cc_pr_poisson$Sexual_minority_2021_crude <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Sexual_minority_2021_crude )

results_cc_pr_poisson$Homosexual_2021_crude <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Homosexual_2021_crude )

results_cc_pr_poisson$Bisexual_2021_crude <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Bisexual_2021_crude )

results_cc_pr_poisson$Other_2021_crude <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Other_2021_crude )

results_cc_pr_poisson$Sexual_minority_2021 <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Sexual_minority_2021 )

results_cc_pr_poisson$Homosexual_2021 <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Homosexual_2021 )

results_cc_pr_poisson$Bisexual_2021 <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Bisexual_2021 )

results_cc_pr_poisson$Other_2021 <- ifelse( !is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ) & is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2021 ), "\u2013",
                                                      results_cc_pr_poisson$Other_2021 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Sexual_minority" = paste( results_cc_pr_poisson$Sexual_minority_2010,
                                         results_cc_pr_poisson$Sexual_minority_2014,
                                         results_cc_pr_poisson$Sexual_minority_2021,
                                         sep = "\n" ),
              .before = 3 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Homosexual" = paste( results_cc_pr_poisson$Homosexual_2010,
                                         results_cc_pr_poisson$Homosexual_2014,
                                         results_cc_pr_poisson$Homosexual_2021,
                                         sep = "\n" ),
              .before = 5 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Bisexual" = paste( results_cc_pr_poisson$Bisexual_2010,
                                         results_cc_pr_poisson$Bisexual_2014,
                                         results_cc_pr_poisson$Bisexual_2021,
                                         sep = "\n" ),
              .before = 7 )
...
results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_column( "Other" = paste( results_cc_pr_poisson$Other_2010,
                                         results_cc_pr_poisson$Other_2014,
                                         results_cc_pr_poisson$Other_2021,
                                         sep = "\n" ),
              .before = 9 )

results_cc_pr_poisson$Sexual_minority_crude <- ifelse( is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Sexual_minority_crude )
results_cc_pr_poisson$Homosexual_crude <- ifelse( is.na( results_cc_pr_poisson$homosexual_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Homosexual_crude )
results_cc_pr_poisson$Bisexual_crude <- ifelse( is.na( results_cc_pr_poisson$bisexual_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Bisexual_crude )
results_cc_pr_poisson$Other_crude <- ifelse( is.na( results_cc_pr_poisson$other_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Other_crude )
results_cc_pr_poisson$Sexual_minority <- ifelse( is.na( results_cc_pr_poisson$sexual_minority_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Sexual_minority )
results_cc_pr_poisson$Homosexual <- ifelse( is.na( results_cc_pr_poisson$homosexual_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Homosexual )
results_cc_pr_poisson$Bisexual <- ifelse( is.na( results_cc_pr_poisson$bisexual_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Bisexual )
results_cc_pr_poisson$Other <- ifelse( is.na( results_cc_pr_poisson$other_point_estimate_2010 ), "",
                                                      results_cc_pr_poisson$Other )

results_cc_pr_poisson <- results_cc_pr_poisson %>% 
  add_row( Exposure = paste0( "   ", "Male" ), 
           Sexual_minority_crude = "Reference",
           Sexual_minority = "Reference",
...
##### 4.1.2. Sexual minority group
###### 4.1.2.1. Part 1
```{r}
results_cc_pr_poisson_sexual_minority <- results_cc_pr_poisson[ -c( 9:14, 28:37 ), c( 1:3, 34:36, 46:48, 58:60, 70:72, 82:84, 94:96 ) ]
...
names( results_cc_pr_poisson_sexual_minority )[ names( results_cc_pr_poisson_sexual_minority ) %in% c( "temp1", "temp2", "Sexual_minority_crude", "Sexual_minority" ) ] <- ""
...
p_cc_pr_poisson_sexual_minority <- add_text(
  p_cc_pr_poisson_sexual_minority,
  text = "Adjusted Proportion Ratio (95% CI)ᵇ",
  col = c( 6:7 ),
  row = 1,
  part = "header",
  gp = gpar(
...
p_cc_pr_poisson_sexual_minority <- edit_plot( p_cc_pr_poisson_sexual_minority,
                           row = c( 2, 3, 5:8, 10:12, 14:16, 18:21 ), 
                           which = "background",
                           gp = gpar( fill = "#eff3f2" )
                           )
...
###### 4.1.2.2. Part 2
```{r}
results_cc_pr_poisson_sexual_minority <- results_cc_pr_poisson[ -c( 9:14, 1:27 ), c( 1:3, 34:36, 46:48, 58:60, 70:72, 82:84, 94:96 ) ]
...
##### 4.1.3. Homosexual group
###### 4.1.3.1. Part 1
```{r}
results_cc_pr_poisson_homosexual <- results_cc_pr_poisson[ -c( 9:14, 28:37 ), c( 1, 4, 5, 37:39, 49:51, 61:63, 73:75, 85:87, 97:99 ) ]
...
names( results_cc_pr_poisson_homosexual )[ names( results_cc_pr_poisson_homosexual ) %in% c( "temp1", "temp2", "Homosexual_crude", "Homosexual" ) ] <- ""
...
###### 4.1.3.2. Part 2
```{r}
results_cc_pr_poisson_homosexual <- results_cc_pr_poisson[ -c( 9:14, 1:27 ), c( 1, 4, 5, 37:39, 49:51, 61:63, 73:75, 85:87, 97:99 ) ]
...
##### 4.1.4. Bisexual group
###### 4.1.4.1. Part 1
```{r}
results_cc_pr_poisson_bisexual <- results_cc_pr_poisson[ -c( 9:14, 28:37 ), c( 1, 6, 7, 40:42, 52:54, 64:66, 76:78, 88:90, 100:102 ) ]
...
names( results_cc_pr_poisson_bisexual )[ names( results_cc_pr_poisson_bisexual ) %in% c( "temp1", "temp2", "Bisexual_crude", "Bisexual" ) ] <- ""
...
###### 4.1.4.2. Part 2
```{r}
results_cc_pr_poisson_bisexual <- results_cc_pr_poisson[ -c( 9:14, 1:27 ), c( 1, 6, 7, 40:42, 52:54, 64:66, 76:78, 88:90, 100:102 ) ]
...
###### 4.1.5.1. Part 1
```{r}
results_cc_pr_poisson_other <- results_cc_pr_poisson[ -c( 9:14, 28:37 ), c( 1, 8, 9, 43:45, 55:57, 67:69, 79:81, 91:93, 103:105 ) ]
...
names( results_cc_pr_poisson_other )[ names( results_cc_pr_poisson_other ) %in% c( "temp1", "temp2", "Other_crude", "Other" ) ] <- ""
...
###### 4.1.5.2. Part 2
```{r}
results_cc_pr_poisson_other <- results_cc_pr_poisson[ -c( 9:14, 1:27 ), c( 1, 8, 9, 43:45, 55:57, 67:69, 79:81, 91:93, 103:105 ) ]
...
##### 4.1.6. Age by sex
###### 4.1.6.1. Prepare dataset for plotting
```{r}
...
results_cc_pr_poisson_age_sex$Exposure[ results_cc_pr_poisson_age_sex$Exposure == "age_exp16-29_Male" ] <- paste0( "   ", "16–29 yrsᶜ\n\n" )
...
results_cc_pr_poisson_age_sex$Exposure[ results_cc_pr_poisson_age_sex$Exposure == "age_exp16-29_Female" ] <- paste0( "   ", "16–29 yrsᶜ\n\n" )
...
results_cc_pr_poisson_age_sex$Sexual_minority <- ifelse( is.na( results_cc_pr_poisson_age_sex$Sexual_minority ), "",
                                                      results_cc_pr_poisson_age_sex$Sexual_minority )
...
results_cc_pr_poisson_age_sex$Homosexual <- ifelse( is.na( results_cc_pr_poisson_age_sex$Homosexual ), "",
                                                      results_cc_pr_poisson_age_sex$Homosexual )
...
results_cc_pr_poisson_age_sex$Bisexual <- ifelse( is.na( results_cc_pr_poisson_age_sex$Bisexual ), "",
                                                      results_cc_pr_poisson_age_sex$Bisexual )
...
results_cc_pr_poisson_age_sex$Other <- ifelse( is.na( results_cc_pr_poisson_age_sex$Other ), "",
                                                      results_cc_pr_poisson_age_sex$Other )
```

###### 4.1.6.2. Sexual minority group
```{r}
results_cc_pr_poisson_age_sex_sexual_minorities <- results_cc_pr_poisson_age_sex[ , c( 1:3, 34:36, 46:48, 58:60, 70:72, 82:84, 94:96 ) ]
...
names( results_cc_pr_poisson_age_sex_sexual_minorities )[ names( results_cc_pr_poisson_age_sex_sexual_minorities ) %in% c( "temp1", "temp2", "Sexual_minority_crude", "Sexual_minority" ) ] <- ""
...
p_cc_pr_poisson_age_sex_sexual_minorities <- forest(
  results_cc_pr_poisson_age_sex_sexual_minorities[ , c( 1:7 ) ],
  
  est = list( results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_point_estimate_crude_2010,
              results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_point_estimate_2010,
              results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_point_estimate_crude_2014,
              results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_point_estimate_2014,
              results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_point_estimate_crude_2021,
              results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_point_estimate_2021
  ),
  
  lower = list( results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_lower_ci_crude_2010,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_lower_ci_2010,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_lower_ci_crude_2014,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_lower_ci_2014,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_lower_ci_crude_2021,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_lower_ci_2021
  ),
  
  upper = list( results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_upper_ci_crude_2010,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_upper_ci_2010,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_upper_ci_crude_2014,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_upper_ci_2014,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_upper_ci_crude_2021,
                results_cc_pr_poisson_age_sex_sexual_minorities$sexual_minority_upper_ci_2021
  ),
...
p_cc_pr_poisson_age_sex_sexual_minorities <- edit_plot( p_cc_pr_poisson_age_sex_sexual_minorities,
                                      row = c( 1, 6 ),
                                      col = 1,
                                      gp = gpar( fontface = "bold" ) 
)

p_cc_pr_poisson_age_sex_sexual_minorities <- add_text(
  p_cc_pr_poisson_age_sex_sexual_minorities,
  text = "Crude Proportion Ratio (95% CI)",
  col = c( 3:4 ),
  row = 1,
  part = "header",
...
p_cc_pr_poisson_age_sex_sexual_minorities <- insert_text(
  p_cc_pr_poisson_age_sex_sexual_minorities,
  text = "Sexual Minoritiesᵃ",
  col = c( 3:7 ),
  row = 1,
...
p_cc_pr_poisson_age_sex_sexual_minorities <- add_border(
  p_cc_pr_poisson_age_sex_sexual_minorities,
  part = "header",
  row = 2,
  col = c( 3:7 ),
...
plot( p_cc_pr_poisson_age_sex_sexual_minorities )
```

###### 4.1.6.3. Homosexual group
```{r}
results_cc_pr_poisson_age_sex_homosexual <- results_cc_pr_poisson_age_sex[ , c( 1, 4, 5, 37:39, 49:51, 61:63, 73:75, 85:87, 97:99 ) ]
...
names( results_cc_pr_poisson_age_sex_homosexual )[ names( results_cc_pr_poisson_age_sex_homosexual ) %in% c( "temp1", "temp2", "Homosexual_crude", "Homosexual" ) ] <- ""
...
p_cc_pr_poisson_age_sex_homosexual <- forest(
  results_cc_pr_poisson_age_sex_homosexual[ , c( 1:7 ) ],
  
  est = list( results_cc_pr_poisson_age_sex_homosexual$homosexual_point_estimate_crude_2010,
              results_cc_pr_poisson_age_sex_homosexual$homosexual_point_estimate_2010,
              results_cc_pr_poisson_age_sex_homosexual$homosexual_point_estimate_crude_2014,
              results_cc_pr_poisson_age_sex_homosexual$homosexual_point_estimate_2014,
              results_cc_pr_poisson_age_sex_homosexual$homosexual_point_estimate_crude_2021,
              results_cc_pr_poisson_age_sex_homosexual$homosexual_point_estimate_2021
  ),
  
  lower = list( results_cc_pr_poisson_age_sex_homosexual$homosexual_lower_ci_crude_2010,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_lower_ci_2010,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_lower_ci_crude_2014,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_lower_ci_2014,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_lower_ci_crude_2021,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_lower_ci_2021
  ),
  
  upper = list( results_cc_pr_poisson_age_sex_homosexual$homosexual_upper_ci_crude_2010,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_upper_ci_2010,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_upper_ci_crude_2014,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_upper_ci_2014,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_upper_ci_crude_2021,
                results_cc_pr_poisson_age_sex_homosexual$homosexual_upper_ci_2021
  ),
...
p_cc_pr_poisson_age_sex_homosexual <- edit_plot( p_cc_pr_poisson_age_sex_homosexual,
                                         row = c( 1, 6 ),
                                         col = 1,
                                         gp = gpar( fontface = "bold" ) 
)

p_cc_pr_poisson_age_sex_homosexual <- add_text(
  p_cc_pr_poisson_age_sex_homosexual,
  text = "Crude Proportion Ratio (95% CI)",
  col = c( 3:4 ),
  row = 1,
  part = "header",
...
p_cc_pr_poisson_age_sex_homosexual <- insert_text(
  p_cc_pr_poisson_age_sex_homosexual,
  text = "Homosexual Identityᵃ",
  col = c( 3:7 ),
  row = 1,
...
p_cc_pr_poisson_age_sex_homosexual <- add_border(
  p_cc_pr_poisson_age_sex_homosexual,
  part = "header",
  row = 2,
  col = c( 3:7 ),
...
plot( p_cc_pr_poisson_age_sex_homosexual )
```

###### 4.1.6.4. Bisexual group
```{r}
results_cc_pr_poisson_age_sex_bisexual <- results_cc_pr_poisson_age_sex[ , c( 1, 6, 7, 40:42, 52:54, 64:66, 76:78, 88:90, 100:102 ) ]
...
names( results_cc_pr_poisson_age_sex_bisexual )[ names( results_cc_pr_poisson_age_sex_bisexual ) %in% c( "temp1", "temp2", "Bisexual_crude", "Bisexual" ) ] <- ""
...
p_cc_pr_poisson_age_sex_bisexual <- edit_plot( p_cc_pr_poisson_age_sex_bisexual,
                                       row = c( 1, 6 ),
                                       col = 1,
                                       gp = gpar( fontface = "bold" ) 
)

p_cc_pr_poisson_age_sex_bisexual <- add_text(
  p_cc_pr_poisson_age_sex_bisexual,
  text = "Crude Proportion Ratio (95% CI)",
  col = c( 3:4 ),
  row = 1,
  part = "header",
...
p_cc_pr_poisson_age_sex_bisexual <- insert_text(
  p_cc_pr_poisson_age_sex_bisexual,
  text = "Bisexual Identityᵃ",
  col = c( 3:7 ),
  row = 1,
...
p_cc_pr_poisson_age_sex_bisexual <- add_border(
  p_cc_pr_poisson_age_sex_bisexual,
  part = "header",
  row = 2,
  col = c( 3:7 ),
...
plot( p_cc_pr_poisson_age_sex_bisexual )
```

###### 4.1.6.5. Other group
```{r}
results_cc_pr_poisson_age_sex_other <- results_cc_pr_poisson_age_sex[ , c( 1, 8, 9, 43:45, 55:57, 67:69, 79:81, 91:93, 103:105 ) ]
...
names( results_cc_pr_poisson_age_sex_other )[ names( results_cc_pr_poisson_age_sex_other ) %in% c( "temp1", "temp2", "Other_crude", "Other" ) ] <- ""
...
p_cc_pr_poisson_age_sex_other <- edit_plot( p_cc_pr_poisson_age_sex_other,
                                    row = c( 1, 6 ),
                                    col = 1,
                                    gp = gpar( fontface = "bold" ) 
)

p_cc_pr_poisson_age_sex_other <- add_text(
  p_cc_pr_poisson_age_sex_other,
  text = "Crude Proportion Ratio (95% CI)",
  col = c( 3:4 ),
  row = 1,
  part = "header",
...
p_cc_pr_poisson_age_sex_other <- insert_text(
  p_cc_pr_poisson_age_sex_other,
  text = "Uncertain/Other Sexual Identitiesᵃ",
  col = c( 3:7 ),
  row = 1,
...
p_cc_pr_poisson_age_sex_other <- add_border(
  p_cc_pr_poisson_age_sex_other,
  part = "header",
  row = 2,
  col = c( 3:7 ),
...
plot( p_cc_pr_poisson_age_sex_other )
```

##### 4.1.7. Proportion and proportion ratio by varing age cut-offs
###### 4.1.7.1. Prepare dataset for plotting
```{r}
...
```
### 5. Plots for Relation between Changes of Sexual Identity and Demographic Factors
...
# merge datasets
fluidity_cc_rr <- full_join( fluidity_cc_rr_2010, fluidity_cc_rr_2014, by = "Exposure" )
...
fluidity_cc_rr$Exposure[ fluidity_cc_rr$Exposure == "age_exp16-29" ] <- paste0( "   ", "16–29 yrsᶜ\n" )
...
fluidity_cc_rr$Exposure[ fluidity_cc_rr$Exposure == "country_of_birth_expEurope" ] <- paste0( "   ", "Europeᵈ\n" )
...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_column( "Sexual_fluidity_2010_adjusted" = paste0(
    sprintf( "%.2f", fluidity_cc_rr$point_estimate_adjusted_2010 ), " (", 
    sprintf( "%.2f", fluidity_cc_rr$lower_ci_adjusted_2010 ), ", ", 
    sprintf( "%.2f", fluidity_cc_rr$upper_ci_adjusted_2010 ), ")" ),
    .before = 6 )
...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_column( "Sexual_fluidity_2014_adjusted" = paste0(
    sprintf( "%.2f", fluidity_cc_rr$point_estimate_adjusted_2014 ), " (", 
    sprintf( "%.2f", fluidity_cc_rr$lower_ci_adjusted_2014 ), ", ", 
    sprintf( "%.2f", fluidity_cc_rr$upper_ci_adjusted_2014 ), ")" ),
    .before = 14 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_column( "Sexual_fluidity_2010" = paste( fluidity_cc_rr$Sexual_fluidity_2010_crude,
                                              fluidity_cc_rr$Sexual_fluidity_2010_adjusted,
                                              sep = "\n" ),
              .before = 2 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_column( "Sexual_fluidity_2014" = paste( fluidity_cc_rr$Sexual_fluidity_2014_crude,
                                              fluidity_cc_rr$Sexual_fluidity_2014_adjusted,
                                              sep = "\n" ),
              .before = 3 )

fluidity_cc_rr$Sexual_fluidity_2010 <- ifelse( is.na( fluidity_cc_rr$point_estimate_crude_2010 ), "",
                                                      fluidity_cc_rr$Sexual_fluidity_2010 )

fluidity_cc_rr$Sexual_fluidity_2014 <- ifelse( is.na( fluidity_cc_rr$point_estimate_crude_2010 ), "",
                                                      fluidity_cc_rr$Sexual_fluidity_2014 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = paste0( "   ", "Male" ), 
           Sexual_fluidity_2010 = "Reference",
           Sexual_fluidity_2014 = "Reference",
           .before = 2 )
...
names( fluidity_cc_rr )[ names( fluidity_cc_rr ) %in% c( "temp1", "temp2", "Sexual_fluidity_2010", "Sexual_fluidity_2014" ) ] <- ""
```
...
fluidity_cc_rr_part_1 <- fluidity_cc_rr[ -c( 9:14, 32:37 ), c( 1:7, 9:11, 13:15, 17:19, 21:23 ) ]
  
p_cc_fluidity_rr <- forest(
  fluidity_cc_rr_part_1[ , c( 1:7 ) ],
  
  est = list( fluidity_cc_rr_part_1$point_estimate_crude_2010,
              fluidity_cc_rr_part_1$point_estimate_crude_2014,
              fluidity_cc_rr_part_1$point_estimate_adjusted_2010,
              fluidity_cc_rr_part_1$point_estimate_adjusted_2014
              ),
  
  lower = list( fluidity_cc_rr_part_1$lower_ci_crude_2010,
                fluidity_cc_rr_part_1$lower_ci_crude_2014,
                fluidity_cc_rr_part_1$lower_ci_adjusted_2010,
                fluidity_cc_rr_part_1$lower_ci_adjusted_2014
                ),
  
  upper = list( fluidity_cc_rr_part_1$upper_ci_crude_2010,
                fluidity_cc_rr_part_1$upper_ci_crude_2014,
                fluidity_cc_rr_part_1$upper_ci_adjusted_2010,
                fluidity_cc_rr_part_1$upper_ci_adjusted_2014
                ),
...
p_cc_fluidity_rr <- edit_plot( p_cc_fluidity_rr,
                                              row = c( 1, 4, 9, 13, 17, 22 ),
                                              col = 1,
                                              gp = gpar( fontface = "bold" ) 
)

p_cc_fluidity_rr <- add_text(
  p_cc_fluidity_rr,
...
p_cc_fluidity_rr <- edit_plot( p_cc_fluidity_rr,
                                              row = c( 2, 3, 5:8, 10:12, 14:16, 18:21, 23:25 ), 
                                              which = "background",
                                              gp = gpar( fill = "#eff3f2" )
)

p_cc_fluidity_rr <- add_border(
  p_cc_fluidity_rr,
  part = "header",
  row = 1,
  col = c( 3:4, 6:7 ),
...
p_cc_fluidity_rr <- insert_text(
  p_cc_fluidity_rr,
  text = "SPHC-B 2010 with SPHC-F 2014–2021ᵃ",
  col = 3:4,
  row = 1,
  part = "header",
  gp = gpar(
...
p_cc_fluidity_rr <- add_text(
  p_cc_fluidity_rr,
  text = "SPHC-B 2014 with SPHC-F 2021ᵇ",
  col = 6:7,
  row = 1,
  part = "header",
  gp = gpar(
...
fluidity_cc_rr_part_2 <- fluidity_cc_rr[ -c( 9:14, 1:31 ), c( 1:7, 9:11, 13:15, 17:19, 21:23 ) ]
  
p_cc_fluidity_rr <- forest(
  fluidity_cc_rr_part_2[ , c( 1:7 ) ],
  
  est = list( fluidity_cc_rr_part_2$point_estimate_crude_2010,
              fluidity_cc_rr_part_2$point_estimate_crude_2014,
              fluidity_cc_rr_part_2$point_estimate_adjusted_2010,
              fluidity_cc_rr_part_2$point_estimate_adjusted_2014
              ),
  
  lower = list( fluidity_cc_rr_part_2$lower_ci_crude_2010,
                fluidity_cc_rr_part_2$lower_ci_crude_2014,
                fluidity_cc_rr_part_2$lower_ci_adjusted_2010,
                fluidity_cc_rr_part_2$lower_ci_adjusted_2014
                ),
  
  upper = list( fluidity_cc_rr_part_2$upper_ci_crude_2010,
                fluidity_cc_rr_part_2$upper_ci_crude_2014,
                fluidity_cc_rr_part_2$upper_ci_adjusted_2010,
                fluidity_cc_rr_part_2$upper_ci_adjusted_2014
                ),
...
###### 5.1.2.3. Part 3 (age by sex)
```{r}
fluidity_cc_rr_part_3 <- fluidity_cc_rr[ c( 9:14 ), c( 1:7, 9:11, 13:15, 17:19, 21:23 ) ]

colnames( fluidity_cc_rr_part_3 )[ 2:7 ] <- c( "temp1", "temp2", "temp3", "temp4", "temp5", "temp6" )

fluidity_cc_rr_part_3 <- fluidity_cc_rr_part_3 %>% 
  add_row( `Demographic Factor` = "Male", .before = 1 )

fluidity_cc_rr_part_3 <- fluidity_cc_rr_part_3 %>% 
  add_row( `Demographic Factor` = "Female", .before = 5 )

fluidity_cc_rr_part_3$`Demographic Factor`[ fluidity_cc_rr_part_3$`Demographic Factor` == "age_exp16-29_Male" ] <- paste0( "   ", "16–29 yrsᶜ\n" )
fluidity_cc_rr_part_3$`Demographic Factor`[ fluidity_cc_rr_part_3$`Demographic Factor` == "age_exp30-44_Male" ] <- paste0( "   ", "30–44 yrs\n" )
fluidity_cc_rr_part_3$`Demographic Factor`[ fluidity_cc_rr_part_3$`Demographic Factor` == "age_exp>=60_Male" ] <- paste0( "   ", "\u2265 60 yrs\n" )

fluidity_cc_rr_part_3$`Demographic Factor`[ fluidity_cc_rr_part_3$`Demographic Factor` == "age_exp16-29_Female" ] <- paste0( "   ", "16–29 yrsᶜ\n" )
fluidity_cc_rr_part_3$`Demographic Factor`[ fluidity_cc_rr_part_3$`Demographic Factor` == "age_exp30-44_Female" ] <- paste0( "   ", "30–44 yrs\n" )
fluidity_cc_rr_part_3$`Demographic Factor`[ fluidity_cc_rr_part_3$`Demographic Factor` == "age_exp>=60_Female" ] <- paste0( "   ", "\u2265 60 yrs\n" )

fluidity_cc_rr_part_3 <- fluidity_cc_rr_part_3 %>% 
  add_row( `Demographic Factor` = paste0( "   ", "45–59 yrs" ), 
           temp3 = "Reference",
           temp6 = "Reference",
           .before = 4 )
...
fluidity_cc_rr_part_3$temp3 <- ifelse( is.na(fluidity_cc_rr_part_3$temp3), "",
                                       fluidity_cc_rr_part_3$temp3 )

fluidity_cc_rr_part_3$temp6 <- ifelse( is.na(fluidity_cc_rr_part_3$temp6), "",
                                       fluidity_cc_rr_part_3$temp6 )

fluidity_cc_rr_part_3_updated <- fluidity_cc_rr_part_3[ , -c( 2, 3, 5, 6 ) ]

fluidity_cc_rr_part_3_updated <- fluidity_cc_rr_part_3_updated %>% 
  add_column( ` ` = paste( rep( " ", 20 ) , collapse = " " ), .before = 2 )
...
names( fluidity_cc_rr_part_3_updated )[ names( fluidity_cc_rr_part_3_updated ) %in% c( "temp1", "temp2", "temp3", "temp6" ) ] <- ""
...
p_cc_fluidity_rr <- forest(
  fluidity_cc_rr_part_3_updated[ , c( 1:7 ) ],
  
  est = list( fluidity_cc_rr_part_3_updated$point_estimate_crude_2010,
              fluidity_cc_rr_part_3_updated$point_estimate_crude_2014,
              fluidity_cc_rr_part_3_updated$point_estimate_adjusted_2010,
              fluidity_cc_rr_part_3_updated$point_estimate_adjusted_2014
              ),
  
  lower = list( fluidity_cc_rr_part_3_updated$lower_ci_crude_2010,
                fluidity_cc_rr_part_3_updated$lower_ci_crude_2014,
                fluidity_cc_rr_part_3_updated$lower_ci_adjusted_2010,
                fluidity_cc_rr_part_3_updated$lower_ci_adjusted_2014
                ),
  
  upper = list( fluidity_cc_rr_part_3_updated$upper_ci_crude_2010,
                fluidity_cc_rr_part_3_updated$upper_ci_crude_2014,
                fluidity_cc_rr_part_3_updated$upper_ci_adjusted_2010,
                fluidity_cc_rr_part_3_updated$upper_ci_adjusted_2014
                ),
