...
ggplot( df_long ) +
  geom_line( aes( x = Municipality, 
                  y = response_rate, 
                  group = interaction( year, response_type ), 
                  color = year, 
...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Cohort yearʰ", .before = 30 )
...
fluidity_cc_rr_part_1 <- fluidity_cc_rr[ -c( 9:14, 23:41 ), ]
...
fluidity_cc_rr_part_2 <- fluidity_cc_rr[ -c( 9:14, 1:22 ), ]
...
```{r}
fluidity_cc_rr_age_by_sex <- fluidity_cc_rr[ c( 9:14 ), ]

colnames(fluidity_cc_rr_age_by_sex)[1:10] <- c("Exposure", paste0("temp", 1:9))

fluidity_cc_rr_age_by_sex <- fluidity_cc_rr_age_by_sex %>% 
  add_row( Exposure = "Male", .before = 1 )

fluidity_cc_rr_age_by_sex <- fluidity_cc_rr_age_by_sex %>% 
  add_row( Exposure = "Female", .before = 5 )

fluidity_cc_rr_age_by_sex$Exposure[ fluidity_cc_rr_age_by_sex$Exposure == "age_exp16-29_Male" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
fluidity_cc_rr_age_by_sex$Exposure[ fluidity_cc_rr_age_by_sex$Exposure == "age_exp30-44_Male" ] <- paste0( "   ", "30–44 yrs\n\n" )
fluidity_cc_rr_age_by_sex$Exposure[ fluidity_cc_rr_age_by_sex$Exposure == "age_exp>=60_Male" ] <- paste0( "   ", "\u2265 60 yrs\n\n" )

fluidity_cc_rr_age_by_sex$Exposure[ fluidity_cc_rr_age_by_sex$Exposure == "age_exp16-29_Female" ] <- paste0( "   ", "16–29 yrsᵈ\n\n" )
fluidity_cc_rr_age_by_sex$Exposure[ fluidity_cc_rr_age_by_sex$Exposure == "age_exp30-44_Female" ] <- paste0( "   ", "30–44 yrs\n\n" )
fluidity_cc_rr_age_by_sex$Exposure[ fluidity_cc_rr_age_by_sex$Exposure == "age_exp>=60_Female" ] <- paste0( "   ", "\u2265 60 yrs\n\n" )
