...
prop_cc_summary_2010 <- prop_cc_summary_2010 %>% slice( -c( 7:11 ) )
prop_cc_summary_2014 <- prop_cc_summary_2014 %>% slice( -c( 7:12 ) )
prop_cc_summary_2021 <- prop_cc_summary_2021 %>% slice( -c( 7:12 ) )
...
```{r}
# datasets for proportion of sexual identity
prop_cc_summary_2010_generation <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_cc_summary_2010.xlsx")
prop_cc_summary_2014_generation <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_cc_summary_2014.xlsx")
prop_cc_summary_2021_generation <- read_excel("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_cc_summary_2021.xlsx")

prop_cc_summary_2010_generation <- prop_cc_summary_2010_generation %>% slice( 7:11 )
prop_cc_summary_2014_generation <- prop_cc_summary_2014_generation %>% slice( 7:12 )
prop_cc_summary_2021_generation <- prop_cc_summary_2021_generation %>% slice( 7:12 )
...
ggplot( drop_na( long_data_generation ), 
  ...
  ggh4x::facetted_pos_scales( y = list(
    ...
    identity == "Homosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.03 ), breaks = c( 0, 0.01, 0.02, 0.03 ) ),
    identity == "Bisexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.1 ), breaks = c( 0, 0.05, 0.1 ) ),
    identity == "Other" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.3 ), breaks = c( 0, 0.1, 0.2, 0.3 ) ) 
    ) )
```
...
```{r}
prop_cc_age_group_2010 <- read_xlsx("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_cc_age_group_2010.xlsx") %>%
...
prop_cc_age_group_2014 <- read_xlsx("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_cc_age_group_2014.xlsx") %>%
...
prop_cc_age_group_2021 <- read_xlsx("/Users/guoqiang.zhang/Documents/Karolinska Institutet/Research Projects/Trends and Fluidity of Sexual Identity/Sexual_identity_in_Stockholm_County/prop_cc_age_group_2021.xlsx") %>%
...
prop_cc_age_group_2010$subgroup[ prop_cc_age_group_2010$subgroup == "[17,19]" ] <- "(17,19]"
prop_cc_age_group_2014$subgroup[ prop_cc_age_group_2014$subgroup == "[15,17]" ] <- "[16,17]"
prop_cc_age_group_2021$subgroup[ prop_cc_age_group_2021$subgroup == "[15,17]" ] <- "[16,17]"
...
ggplot( long_data_age_group, 
  ...
  scale_y_continuous( labels = scales::percent,
                      limits = c( 0, 1 ), 
                      breaks = c( 0, 0.05, 0.1, 0.15, 0.8, 0.9, 1 )
                      ) +
  
  scale_y_break( c( 0.17, 0.72 ), scales = 1, space = 0.3, expand = c( 0, 0 ) ) +
...
fluidity_cc_prop_summary <- fluidity_cc_prop_summary %>% 
  add_row( subgroup = "Occupationᶠ", .before = 32 )

fluidity_cc_prop_summary <- fluidity_cc_prop_summary %>% 
  add_row( subgroup = "Income (100 kr/yr)ᵍ", .before = 36 )
...
fluidity_cc_prop_summary$subgroup[ fluidity_cc_prop_summary$subgroup == "16-29" ] <- "16–29 yrsᵈ"
...
fluidity_cc_prop_summary$subgroup[ fluidity_cc_prop_summary$subgroup == "16-29.Male" ] <- "16–29 yrsᶜ"
...
fluidity_cc_prop_summary$subgroup[ fluidity_cc_prop_summary$subgroup == "16-29.Female" ] <- "16–29 yrsᶜ"
...
fluidity_cc_prop_summary$subgroup[ fluidity_cc_prop_summary$subgroup == "Europe" ] <- "Europeᵉ"
...
fluidity_cc_prop_summary <- fluidity_cc_prop_summary %>% 
  add_column( "SPHC 2002–2010" = paste0(
...
fluidity_cc_prop_summary$`SPHC 2002–2010` <- ifelse( 
  is.na( fluidity_cc_prop_summary$changed_point_estimate_2010_2021 ) &
    is.na( fluidity_cc_prop_summary$changed_point_estimate_2010 ), "",
  fluidity_cc_prop_summary$`SPHC 2002–2010` )
fluidity_cc_prop_summary$`SPHC 2002–2010`[ fluidity_cc_prop_summary$`SPHC 2002–2010` == "NA (NA, NA)" ] <- "\u2013"
...
colnames( fluidity_cc_prop_summary_updated )[ colnames( fluidity_cc_prop_summary_updated ) == "SPHC 2002–2010" ] <- ""
...
p_prop_cc_fluidity <- insert_text(
  p_prop_cc_fluidity,
  text = "Pooled Cohort from SPHC 2002–2010ᵃ",
  col = 3:6,
  row = 1,
  part = "header",
  gp = gpar(
...
colnames(fluidity_cc_prop_summary_updated_part_3)[1] <- "Age Group"
...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Sexual identityᵈ", .before = 1 )
...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Income (100 kr/yr)ᵍ", .before = 25 )

fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Marital statusʰ", .before = 29 )
...
fluidity_cc_rr <- fluidity_cc_rr %>% 
  add_row( Exposure = "Cohort yearⁱ", .before = 36 )
...
fluidity_cc_rr$Exposure[ fluidity_cc_rr$Exposure == "age_exp16-29" ] <- paste0( "   ", "16–29 yrsᵉ\n\n" )
...
fluidity_cc_rr$Exposure[ fluidity_cc_rr$Exposure == "country_of_birth_expEurope" ] <- paste0( "   ", "Europeᶠ\n\n" )
...
tm <- forest_theme(
  base_size = 10,
  colhead = list( fg_params = list( fontsize = 10 ) ),
  legend_value = c( "Pooled Cohort from SPHC 2002–2010", "SPHC 2010", "SPHC 2014" ),
  legend_name = NULL,
  legend_position = "bottom",
  base_family = "Arial",
  refline_lty = "dashed",
...
fluidity_cc_rr_part_1 <- fluidity_cc_rr[ c( 1:5), ]
...
fluidity_cc_rr_part_2 <- fluidity_cc_rr[ -c( 1:5, 14:23, 32:50 ), ]
...
fluidity_cc_rr_part_3 <- fluidity_cc_rr[ c( 32:50 ), ]
...
colnames( fluidity_cc_rr_age_by_sex )[1] <- "Age Group"
