...
This document presents the analyses among individuals who provided data on sexual identity in the follow-up surveys (SPHC-F 2010, 2014, and 2021) following their participation in the baseline surveys (SPHC-B 2002, 2006, and 2010). The analyses include:
...
The analyses examining the relationship between changes in sexual identity and demographic factors in SPHC-B 2010 and 2014 are available, respectively, in the R scripts "SPHC-B_2010" and "SPHC-B_2014".
...
all_colors <- c( "#00BFC4", "#7CAE00", "#FFA500", "#F8766D", 
                 "#FFFF00", "#0072B2", "#0000FF", "#4B0082", 
                 "#00FF00", "#DEB887", "#00A86B", "#FF0000", 
                 "#800020", "#E6E6FA", "#87CEEB", "#C77CFF" )

legend_labels <- setNames(
  c( "Homosexual to homosexual", "Bisexual to bisexual", "Heterosexual to bisexual", "Uncertain to other",
     "Homosexual to heterosexual", "Bisexual to heterosexual", "Uncertain to heterosexual", "Bisexual to other",
     "Heterosexual to homosexual", "Uncertain to bisexual", "Bisexual to homosexual", "Homosexual to bisexual",
     "Homosexual to other", "Uncertain to homosexual", "Heterosexual to other", "Heterosexual to heterosexual"),
  ordered_levels )
...
ggplot( x123_all_long,
  ...
  geom_text_repel( stat = "alluvium",
                   aes( x = as.integer( year ) + 0.15,
                        color = factor( sexual_identity_2010_2014, 
                                        levels = ordered_levels ),
                        label = ifelse( year == "sexual_identity_2021" & 
