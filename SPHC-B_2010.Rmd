...
x9 <- table( d_2010$occupation, d_2010$sexual_identity )
x9
...
prop_cc_occupation <- left_join( prop_cc_occupation,
                                d_2010_complete_cc[ !is.na( d_2010_complete_cc$sexual_identity ) & !is.na( d_2010_complete_cc$occupation ), ] %>% 
...
d_2010_cc_model$sexual_minority <- ifelse( d_2010_cc_model$sexual_identity == "Heterosexual", 0, 1 )

d_2010_cc_model$homosexual <- ifelse( d_2010_cc_model$sexual_identity == "Homosexual", 1, 0 )

d_2010_cc_model$bisexual <- ifelse( d_2010_cc_model$sexual_identity == "Bisexual", 1, 0 )

d_2010_cc_model$other <- ifelse( d_2010_cc_model$sexual_identity == "Uncertain", 1, 0 )
