...
selected_variables <- c( "sampling_strata_region", "no.of.population", "calibrated_weight", "sexual_identity_2014", "sexual_identity_2021", "age", "sex", "country_of_birth", "education", "dispink2014", "marital_status", "living_alone", "personal_support" )

d_2014_incomplete <- d_2014 %>% 
  select( all_of( selected_variables ) ) %>%
   mutate( country_of_birth = as.factor( 
    case_when(
...
miss_var_summary( d_2014_incomplete ) # 37.6% missing in sexual_identity_2021, 9.0% in sexual_identity_2014, 8.2% in personal_support, 7.5% in living_alone, 0.7% in education, 0.2% in income
```
...
fml_imp_2014 <- sexual_identity_2021 + sexual_identity_2014 + personal_support + living_alone + education + income ~ 1 + age*sex + country_of_birth + marital_status + ( 1 | weight_strata )
...
imp_final_2014 <- jomoImpute( data = d_2014_incomplete,
                              ...
                              m = 50,
                              seed = 12345
                              ) # took around 15 hours and 20 minutes
...
# sexual identity in 2021
ggplot( all_data_2014[ !is.na( all_data_2014$sexual_identity_2021 ), ],
...
nrow( all_data_2014[ all_data_2014$income < 0 & !is.na( all_data_2014$income ), ] ) #  441 imputed values are negative
all_data_2014$income <-ifelse( all_data_2014$income < 0, 0, all_data_2014$income )
```
