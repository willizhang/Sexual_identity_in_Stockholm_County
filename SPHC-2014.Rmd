...
```{r}
summary( d_2014 )
selected_variables <- c( "sampling_strata_region", "no.of.population", "sample_size", "calibrated_weight", "sexual_identity_2014", "sexual_identity_2021", "age", "sex", "country_of_birth", "utbniva2014", "dispink2014", "marital_status", "living_alone", "F14U56G66" )
...
###### 3.2.1.3. Two-level multivariate normal imputation with latent normal variables approach
```{r}
